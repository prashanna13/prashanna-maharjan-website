...
// External URLs should stay untouched
...
// Vercel deployment with Vite base: "/"
return `/${cleanPath
    .split('/')
...
? project.gallery.map((image) => withBaseUrl(image))
: [],

landscapeGallery: Array.isArray(project.landscapeGallery)
? project.landscapeGallery.map((image) => withBaseUrl(image))
: []
}))
