export const projects = [
  {
    ...
    discipline: 'Build',
    year: '2026',
    summary: 'A polished beauty and glam experience designed for discovery and conversion.',
    description:
  ...
  },
  {
    ...
    discipline: 'Build',
    year: '2026',
    summary: 'A focused fitness platform built around energy, clarity and action.',
    description:
  ...
  },
  {
    ...
    discipline: 'Frame',
    year: '2026',
    summary: 'A wedding story told through candid gestures, celebration and quiet in-between moments.',
    description: 'A collection of wedding photographs focused on connection, movement and the atmosphere of the day.',
  ...
  },
  {
    ...
    discipline: 'Frame',
    year: '2026',
    summary: 'Unscripted frames gathered from streets, corners and everyday movement.',
    description: 'A street photography series observing light, people and the small scenes that shape a city.',
    image: '/analog/1.JPG',
    gallery: [
      '/analog/2.JPG',
    ],
  ...
  },
  {
    ...
    discipline: 'Frame',
    year: '2026',
    summary: 'Ritual, place and living heritage documented with a patient eye.',
    description: 'A visual record of cultural spaces, gestures and traditions rooted in the places where they live.',
    ...
    landscapeGallery: ['/bhaktapur/2.jpg', '/bhaktapur/6.jpg', '/bhaktapur/10.jpg', '/bhaktapur/11.jpg'],
  ...
  },
  {
    ...
    discipline: 'Motion',
    year: '2026',
    summary: 'A quiet documentary about clay, labor, ritual and the rhythm of making.',
    description: 'A filmic study of clay, process and the hands that turn raw earth into something useful.',
    ...
    technologies: ['Photographer', 'Videography', 'Editing'],
  ...
  },
  {
    ...
    discipline: 'Frame',
    year: '2026',
    summary: 'A portrait series shaped by place, expression and the feeling of a shared moment.',
    description: 'An intimate portrait collection made around natural light, honest gestures and a strong sense of place.',
  ...
  },
  {
    ...
    discipline: 'Frame',
    year: '2026',
    summary: 'A documentary series shaped by ritual, place and the people who keep culture moving.',
    description: 'A cultural photography collection observing tradition, community and the details that give each place its character.',
  ...
  },
  {
    ...
    discipline: 'Frame',
    year: '2026',
    summary: 'A celebration captured through family, ceremony and the energy of a wedding day.',
    description: 'A wedding photography collection focused on candid emotion, traditional details and joyful celebration.',
...
export const disciplines = [
  ...
  },
  {
    ...
    title: 'Videography',
    blurb:
      'Commercials and documentaries shaped by rhythm, atmosphere and story. Wedding shoot, Events.',
    image:
