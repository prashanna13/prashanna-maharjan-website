...
function VintageCameraModel() {
  ...
  return (
    <div className="vintage-camera-model" ref={containerRef} aria-label="Interactive vintage camera 3D model" role="img" />
  )
}

export default VintageCameraModel